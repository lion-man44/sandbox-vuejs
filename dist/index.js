...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"searchbox-template"}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.searchText),expression:"searchText"}],attrs:{"type":"text","placeholder":"Search..."},domProps:{"value":_vm._s(_vm.searchText)},on:{"input":function($event){if($event.target.composing){ return; }_vm.searchText=$event.target.value}}}),_c('p',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.stocked),expression:"stocked"}],attrs:{"type":"checkbox","id":"stock"},domProps:{"checked":Array.isArray(_vm.stocked)?_vm._i(_vm.stocked,null)>-1:(_vm.stocked)},on:{"change":function($event){var $$a=_vm.stocked,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$c){$$i<0&&(_vm.stocked=$$a.concat($$v))}else{$$i>-1&&(_vm.stocked=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.stocked=$$c}}}}),_c('label',{attrs:{"for":"stock"}},[_vm._v(" Only show products in stock")])]),_c('table',[_vm._m(0),_c('tbody',_vm._l((_vm.filteredProducts),function(p){return _c('tr',[_c('td',{class:{ soldout: !p.stocked }},[_vm._v(_vm._s(p.name))]),_c('td',[_vm._v(_vm._s(p.price))]),_c('td',[_vm._v(_vm._s(p.category))])])}))])])}
__vue__options__.staticRenderFns = [function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('thead',[_c('tr',[_c('th',[_vm._v("Name")]),_c('th',[_vm._v("Price")]),_c('th',[_vm._v("Category")])])])}]
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1d21cd08", __vue__options__)
  } else {
    hotAPI.reload("data-v-1d21cd08", __vue__options__)
  }
})()}
...
var _searchbox = require('./components/searchbox.vue');
...
new _vue2.default({
  el: '#container',
  render: function render(h) {
    return h(_searchbox2.default);
  }
});

},{"./components/searchbox.vue":5,"vue/dist/vue":3}]},{},[6]);
